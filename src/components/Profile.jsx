...
function Profile() {
  ...
  return (
    <div className='profile h-full w-full items-center justify-items-stretch text-gray-600'>
      
      <div className='inline-block w-36 h-36 rounded-full bg-gray-500'>
      ...
      <div className='flex profiledata'>
        <div className='inline-block w-4/6 h-full'>
